...
function hc_include_hc_adv_image_box(&$Y_NOW,$EXTRA) {
    ...
    <div <?php hc_echo(esc_attr($Y_NOW["id"]),'id="','"'); ?> class="img-box adv-img adv-img-classic-box <?php echo esc_attr($css_cnt); ?>" style="<?php  echo esc_attr($Y_NOW["custom_css_styles"]); ?>">
        <div class="img-box">
            <img alt="" src="<?php echo esc_url($img)?>">
        </div>
