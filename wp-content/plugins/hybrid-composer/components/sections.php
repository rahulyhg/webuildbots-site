...
<div id="<?php echo esc_attr($Y_NOW['id']); ?>" class="section-item section-bg-video <?php
    ...
    <div class="videobox">
        ...
        <video autoplay playsinline loop muted poster="<?php echo hc_get_img($SECTION_SETTINGS['image'],"hd"); ?>">
...
?>
<div id="<?php echo $Y_NOW['id']; ?>" class="section-item section-two-blocks <?php echo $css ?>"
...
<div id="<?php echo esc_attr($Y_NOW['id']); ?>" class="section-map box-middle-container <?php echo esc_attr($Y_NOW["css_classes"] . $Y_NOW["custom_css_classes"]) ?>" style="<?php echo 'height: ' . esc_attr($Y_NOW["map_height"]) . 'px; '. esc_attr($Y_NOW["custom_css_styles"]) ?>">
