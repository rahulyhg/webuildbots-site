...
?>
<div class="advs-box advs-box-side <?php echo hc_get_component_classes($Y_NOW,$EXTRA) . ' ' . $boxed . $css; ?>" style="<?php echo esc_attr($Y_NOW["custom_css_styles"]); ?>" <?php echo $button_out ?>>
    <div class="row">
...
<div class="advs-box advs-box-top-icon <?php echo hc_get_component_classes($Y_NOW,$EXTRA) . ' ' . $boxed . $css ?>"
    <?php if (strlen($icon) > 0 ) echo 'data-anima="borderPulse" data-trigger="hover"'; ?>
    style="<?php echo esc_attr($Y_NOW["custom_css_styles"]);
                 if ($icon == "" && $boxed == "") echo " padding-top:0 !important; margin-top:0 !important;";
                 if ($icon == "" && $boxed != "") echo " padding-top:25px !important; margin-top:0 !important;"
           ?>" <?php $button_out ?>>
    <?php echo $icon; ?>
    <h4>
        <?php echo esc_attr($Y_NOW["title"]); ?>
...
<?php }
    if ($style == "side_icon") {
        $icon = hc_get_icon($Y_NOW["icon"], $Y_NOW["icon_style"], $Y_NOW["icon_image"], "icon anima");
?>
<div class="advs-box advs-box-side-icon <?php echo hc_get_component_classes($Y_NOW,$EXTRA) . ' ' . $boxed . $css ?>" <?php if (strlen($icon) > 0 ) echo 'data-anima="borderPulse" data-trigger="hover"'; ?> style="<?php  echo esc_attr($Y_NOW["custom_css_styles"]); ?>" <?php echo $button_out ?>>
...
<?php }
    if ($style == "multiple_box") {
        $icon = hc_get_icon($Y_NOW["icon"], $Y_NOW["icon_style"], $Y_NOW["icon_image"], "icon anima");
?>
<div class="advs-box advs-box-multiple <?php echo hc_get_component_classes($Y_NOW,$EXTRA) . ' ' . $boxed . $css ?>" data-anima="borderPulse" data-trigger="hover" style="<?php  echo esc_attr($Y_NOW["custom_css_styles"]); ?>" <?php echo $button_out ?>>
    <a class="img-box">
        <img alt="" class="anima" src="<?php echo hc_get_img($Y_NOW["image"],"large"); ?>" />
    </a>
    <div class="circle borderPulse anima">
...
<div class="advs-box advs-box-side-img <?php echo hc_get_component_classes($Y_NOW,$EXTRA) . ' ' . $boxed; ?>" style="<?php  echo esc_attr($Y_NOW["custom_css_styles"]); ?>">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <a <?php hc_set_link_settings($Y_NOW, " btn anima-button"); ?>>
...
<div class="advs-box advs-box-top-icon-img niche-box-post blog-manual <?php if ($Y_NOW["extra_content"] == "") echo "no-block-infos "; echo hc_get_component_classes($Y_NOW,$EXTRA) . ' ' . $boxed; ?>" style="<?php echo esc_attr($Y_NOW["custom_css_styles"]); ?>">
    ...
    <div class="advs-box-content">
        ...
        <a <?php hc_set_link_settings($Y_NOW, "anima-button circle-button btn"); ?>>
            <i class="fa fa-long-arrow-right"></i><?php echo esc_attr($Y_NOW["button_text"]); ?>
        </a>
        <?php } ?>
    </div>
...
<div class="list-group pricing-table <?php echo hc_get_component_classes($Y_NOW,$EXTRA); if ($Y_NOW["featured"] == "true") echo " pricing-table-big"; ?>" style="<?php  echo esc_attr($Y_NOW["custom_css_styles"]); ?>">
    ...
    if ($link != "") echo '<div class="list-group-item"><a class="btn btn-default pricing-button-space" href="' . esc_url($link) . '">' . hc_get_now($Y_NOW,"button_text","Details") .'</a></div>';
    ?>
</div>
<?php }
...
<div class="call-action-box vertical-row <?php echo hc_get_component_classes($Y_NOW,$EXTRA); ?>" style="<?php echo esc_attr($Y_NOW["custom_css_styles"]); ?>">
    <div class="row">
        ...
        <div class="col-md-8 vertical-col">
            <p>
        ...
        <div class="<?php if ($Y_NOW["icon"] != "") echo 'col-md-3'; else echo 'col-md-4'; ?>  vertical-col">
