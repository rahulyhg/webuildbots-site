...
<div class="collapse-box <?php echo hc_get_component_classes($Y_NOW,$EXTRA); ?>" <?php hc_echo(esc_attr($Y_NOW["height"]),"data-height='","'"); ?> style="<?php  echo esc_attr($Y_NOW["custom_css_styles"]); ?>">
    <?php if ($Y_NOW["position"] == "top") echo '<div class="text-' . esc_attr(hc_get_now($Y_NOW,"alignment","center")) .'"><a class="collapse-button" data-button-open-text="' . hc_get_now($Y_NOW,"button_open_text","Close") . '"'. hc_get(esc_attr($Y_NOW["time"])," data-time='","'") .'><b>' . esc_attr($Y_NOW["button_text"]) . '</b><span class="caret"></span></a></div>'; ?>
    <div class="panel">
        <?php
    $arr = $Y_NOW["content"];
    $CURRENT_SECTION = $Y_NOW["content"];
    ...
    <?php if ($Y_NOW["position"] == "bottom") echo '<div class="text-' . hc_get_now($Y_NOW,"alignment","center") .'"><a class="collapse-button" data-button-open-text="' . hc_get_now($Y_NOW,"button_open_text","Close") . '" ' . hc_get(esc_attr($Y_NOW["time"])," data-time='","'") .'><b>' . esc_attr($Y_NOW["button_text"]) . '</b><span class="caret"></span></a></div>'; ?>
</div>
<?php }
