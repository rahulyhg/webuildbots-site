...
<form name='hc_settings_form' id="hc_settings_form" method='post' class="y_form ypanel">
    <div class="brand-title" <?php if (file_exists(HC_PLUGIN_PATH . '/custom/logo-panel.png')) echo 'style="background-image:url(' . HC_PLUGIN_URL. '/custom/logo-panel.png)"'; ?>>
        <p>Version <?php if (HC_IS_CUSTOM_PANEL && isset($HC_CUSTOM_PANEL["version"])) echo $HC_CUSTOM_PANEL["version"]; else echo "1.2"; ?></p>
        <a href="https://socanny.ticksy.com/articles/100010383" target="_blank"><i class="fa fa-book"></i><?php _e("Documentation","hc") ?></a>
    </div>
    <div class="ytab tab-box left">
        ...
        <div class="panel-box col-md-10">
            <div class="panel active">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Secondary logo is used on fixed menu, transparent menu and middle logo menu.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="upload-box upload-row float-left">
                            <span class="close-button"></span>
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p>
                            <?php _e("Select the secondary font family for your website. This font is only used in some elements.") ?>
                        </p>
                    </div>
                    <div class="col-md-6">
                        <div class="row input-font-cnt">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Additional color, used on some elements.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-color input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Add a nice effect on page scroll.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
            ...
            <div class="panel">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Add a background to all the pages of your website. *Supported only on boxed layout.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Set the top \ bottom padding for page sections, this setting is only applied on mobile devices.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-text input-row small-input">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Set the bottom margins for some elements like the titles and text blocks.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-text input-row small-input">
            ...
            <div class="panel">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Hamburger menu button. *Only for side menus.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Lateral dropdown layout. *Only for side menus.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Show search box on the right side of menu.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Show a search button on the right side of menu.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Set full width size for the dropdown mega menu. *Only for horizontal menus.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Top padding of the columns of mega menu. *Only for mega menus.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-text input-row small-input">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Show the WPML language selector on the menu. You must install and activate the WPML plugin.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Custom content to be shown in the menu. HTML is allowed.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-text-area full-input" spellcheck="false">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Custom content for middle box. HTML is allowed. *Only for middle box menus","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-text-area full-input" spellcheck="false">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Show a secondary menu bar on top.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-checkbox input-row">
                ...
                <div id="top-area-options">
                    ...
                    <div class="row item-row">
                        <div class="col-md-6 yinfo-bar">
                            <h4><?php _e("Search box","hc") ?></h4>
                            <p><?php _e("Show the search box on the right.","hc") ?></p>
                        </div>
                        <div class="col-md-6">
                            <div class="input-checkbox input-row">
                    ...
                    <div class="row item-row">
                        <div class="col-md-6 yinfo-bar">
                            ...
                            <p><?php _e("Custom content of the top menu. HTML is allowed.","hc") ?></p>
                        </div>
                        <div class="col-md-6">
                            <div class="input-text-area full-input" spellcheck="false">
            ...
            <div class="panel">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        <h4><?php _e("Scroll to top button","hc") ?></h4>
                        <p><?php _e("Show the scroll to top button on bottom right of the page.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-select input-row">
                            <?php
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Add a background image to the footer.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="upload-box upload-row upload-box-full">
                            <span class="close-button"></span>
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Content for footer left area. HTML is allowed.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Content for footer center area. HTML is allowed.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Content for footer right area. HTML is allowed.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Set the copyright text. Displayed below the footer.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <?php
                        if (function_exists('icl_object_id')) {
            ...
            <div class="panel">
                <div class="help-row">
                    ...
                    <p>
                        Lists allow you to create custom post types, like portfolio.
                        With the lists your archive page become a standard page, and like all pages, you can insert any content you need and customize it without any limitaion.
                        To show the items use the Post Type components,(Grid list - Post type component or the Masonry list - Post type component).
            ...
            <div class="panel">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Select the sidebar for shop archive page, set the sidebar content on Apparence > Widgets","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-select input-row">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Select the sidebar for single product item of the shop, set the sidebar content on Apparence > Widgets","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-select input-row">
            ...
            <div class="panel">
                <div class="help-row">
                    <p>
                        Set the title type and design that is applied to auto-generated pages like the woocommerce product page, search page, or any other page generated by external plugins.
                    </p>
                </div>
                <hr class="space s" />
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Add a background image for the title. All title types support background image, video background will require image for mobile. Title slider supports up to 3 images.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="upload-box upload-row upload-box-full">
                            <span class="close-button"></span>
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        <h4><?php _e("Ken-burns effect","hc") ?></h4>
                        <p><?php _e("Set the ken-burns animation. *Supported only for image title with parallax active.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-select input-row">
                            <?php
            ...
            <div class="panel">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Export all theme options settings in a json file.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Import settings by pasting the text of demo json file or your exported json file.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
                        <div class="input-text-area" spellcheck="false">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("LocalStorage is used for Hybrid Composer cache and for the Copy and paste feature, when it's full these functionality stops working and you need to click this button.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="panel">
                ...
                <div class="row item-row">
                    <div class="col-md-6 yinfo-bar">
                        ...
                        <p><?php _e("Insert the links to your social pages.","hc") ?></p>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="panel">
                ...
                <div id="demo-manual">
                    <span onclick="$('#demo-manual > div').show(); $(this).hide()"><?php _e("One Click Install not working?","hc") ?></span>
                    <div>
                        <h4>Manual importing</h4>
                        <p>
                            To solve the problem, go to the folder you downloaded from ThemeForest (should be All files & documentation, not the installable zip) and look for Demo Content (manual install). Select demo.zip from the desired demo folder, upload it to /wp-content/uploads/  and press the button below.
                        </p>
