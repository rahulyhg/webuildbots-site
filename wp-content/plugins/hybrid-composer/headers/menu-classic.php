...
// =============================================================================
$menu_cta_text = hc_get_setting('menu-cta-text');
$menu_cta_link = hc_get_setting('menu-cta-link');
$home_url = home_url();
...
for ($i = 0; $i < $menu_count; $i++) {
    ...
    if ($menu_css[0] != "menu-obj") {
        if (($hc_menu_type == "middle-logo") && ($i == $menu_middle_count)) {
            $menu_html .= '<li class="logo-item ' . ((hc_is_setted("menu-top-logo")) ? "scroll-show" : "") . '"><a href="' . $home_url . '"><img src="' . hc_get_setting("logo-2") . '" alt="logo" style="'. $hc_logo_margin_top . '"></a></li>';
        }
        ...
        <div class="navbar navbar-main <?php if ($hc_menu_type == "middle-logo") echo 'navbar-middle'; if ($hc_menu_type == "middle-box") echo 'middle-box-menu '; if ($hc_menu_type == "icons") echo 'icon-menu'; ?>">
            <div class="container">
                ...
                <div class="scroll-hide">
                    <div class="container">
                        <?php
                           if ($hc_is_transparent) echo "<a class='navbar-brand center scroll-hide' href='" . $home_url . "'><img src='" . esc_url(hc_get_setting("logo-2")) . "' alt='' style='" . esc_attr($hc_logo_2_margin_top) . "' /></a>";
                ...
                <div class="navbar-header">
                    ...
                    if ($hc_is_transparent) {
                        echo "<a class='navbar-brand scroll-hide' href='" . $home_url . "'><img class='logo-default' src='" . hc_get_setting("logo-2") . "' alt='' style='" . esc_attr($hc_logo_2_margin_top) . "'/>
                              <img class='logo-retina' src='" . hc_get_setting("logo-2-retina") . "' alt='' style='" . esc_attr($hc_logo_margin_top) . "' /></a>";
                    ...
                    <div class="nav navbar-nav navbar-right">
                        ...
                        <form role="search" method="get" id="searchform" class="navbar-form" action="<?php echo $home_url ?>">
                            <div class="input-group">
                                <input name="s" id="s" type="text" class="form-control search-form-default" placeholder="<?php esc_attr_e( 'Type and hit enter','hc'); ?>" />
                            </div>
                        </form>
                        <?php } ?>
                        ...
                        <form role="search" method="get" id="searchform" onsubmit="return true" class="navbar-form" action="<?php echo esc_url(HC_SITE_URL) ?>">
                            <div class="search-box-menu">
                                <div class="search-box scrolldown">
                                    ...
                                    <input type="submit" id="searchsubmit" class="btn btn-default" value="<?php esc_attr_e( 'GO','hc'); ?>" />
                                </div>
                                <button class="search-icon btn-search" value="<?php esc_attr_e( 'GO','hc'); ?>">
                        ...
                        <?php if (hc_is_setted('menu-cta-text')) echo '<a class="btn btn-default btn-border menu-cta" href="' . esc_attr($menu_cta_link) . '" target="_blank">' . esc_attr__($menu_cta_text,'hc') . '</a>'?>
